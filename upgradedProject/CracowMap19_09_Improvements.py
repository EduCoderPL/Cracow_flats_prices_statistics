...
class Scrapper:
    ...
    def scrap_one_page(self, page_number: int):
...
class MainApp:
    ...
    def run(self):
        ...
        regions_geodata = generate_geodata(grouped_df)

        self.map_generator.generate_map(regions_geodata, "mapa_oferty_kraków_test.html")
